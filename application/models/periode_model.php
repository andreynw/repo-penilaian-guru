...
class periode_Model extends CI_Model
{
    ...
    public function get_DokumenGuru_ByPeriode($periode_id)
    {
        $this->db->select('dokumen_guru.*, periode.nama_periode');
        $this->db->from('dokumen_guru');
        $this->db->join('periode', 'dokumen_guru.periode_id = periode.id_periode');
        $this->db->where('dokumen_guru.periode_id', $periode_id);
