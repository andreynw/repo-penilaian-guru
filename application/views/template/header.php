        ...
        <div class="main-header" data-background-color="purple">
            ...
            <div class="logo-header">
                <a href="<?= base_url('admin'); ?>" class="logo">
                    <img src="<?= base_url(); ?>assets/img/logo-sma (1).png" alt="navbar brand" class="navbar-brand">
                </a>
            ...
            <div class="sidebar-wrapper scrollbar-inner">
                <div class="sidebar-content">
                    ...
                    <ul class="nav">
                        ...
                        <?php } ?>
                        <li class="nav-item <?php if ($position == 'DokumenGuru') { ?> active <?php } ?>">
                            <a href="<?= base_url('dokumenguru') ?>">
