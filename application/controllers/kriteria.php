...
class kriteria extends CI_Controller
{
    ...
    public function ubah($id)
    {
        ...
        $this->form_validation->set_rules('indikator1', 'Indikator 1', 'required|trim');
        $this->form_validation->set_rules('indikator2', 'Indikator 2', 'required|trim');
        $this->form_validation->set_rules('indikator3', 'Indikator 3', 'required|trim');
        $this->form_validation->set_rules('indikator4', 'Indikator 4', 'required|trim');
        $this->form_validation->set_rules('indikator5', 'Indikator 5', 'required|trim');
